...
const DOWNLOAD_LINKS = {
  ...
  macArm64: "https://github.com/FaithCore-SaaS-Project/faithcore-desktop-releases/releases/download/v1.0.0/FC.Desktop.Setup.1.0.0.exe", // Fallback to same installer
  macX64: "https://github.com/FaithCore-SaaS-Project/faithcore-desktop-releases/releases/download/v1.0.0/FC.Desktop.Setup.1.0.0.exe", // Fallback to same installer
  macUniversal: "https://github.com/FaithCore-SaaS-Project/faithcore-desktop-releases/releases/download/v1.0.0/FC.Desktop.Setup.1.0.0.exe", // Fallback to same installer
};
