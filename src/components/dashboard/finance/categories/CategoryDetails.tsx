  ...
  return (
    <div className="space-y-5">
      ...
      <div className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm">
        ...
        {/* Action Buttons */}
        <button className="w-full mt-6 bg-[#1B2F5E] hover:bg-[#15254A] text-white py-3 rounded-xl flex items-center justify-center gap-2 text-sm font-bold shadow-md shadow-[#1B2F5E]/10 hover:shadow-lg transition-all duration-200">
          <Pencil size={14} />
          Edit Category
        </button>
