      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full bg-[#f8f9ff] border border-gray-100 focus:border-[#1B2F5E] focus:bg-white rounded-xl py-3 pl-11 pr-4 text-sm outline-none transition-all duration-200 text-gray-800"
          />
        </div>
