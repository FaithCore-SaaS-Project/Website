  ...
  return (
    <section className="relative overflow-hidden">
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-16 px-6 py-24 lg:grid-cols-2 lg:items-center">
        {/* ── Left: Copy ─────────────────────────────────── */}
        <div>
          <div className="mb-6 inline-flex items-center rounded-full bg-[#ede9fe] px-4 py-2 text-sm font-medium text-[#5B3DF5]">
          ...
          <h1 className="text-5xl font-extrabold leading-tight lg:text-7xl">
            ...
            Empower Ministry.
            <br />
            <span className="text-[#5B3DF5]">Impact More Lives.</span>
          </h1>
          ...
          <div className="mt-10 flex flex-wrap gap-5">
            <button className="flex items-center gap-2 rounded-2xl bg-[#5B3DF5] px-7 py-4 font-semibold text-white hover:bg-[#4d31db] transition-colors">
              Start Free Trial
              <ArrowRight size={18} />
            </button>
        ...
        <div className="relative">
          ...
          {/* Decorative orbs */}
          <div className="absolute -bottom-8 -left-8 h-44 w-44 rounded-full bg-[#5B3DF5]/20 blur-3xl pointer-events-none" />
